    ...
    <form onSubmit={nameSubmit}>
      <div className='rightbar'>
        <div className='rightbar-buttons'>
          <ul>
            <li className='boxLabel'><Typography variant="h6"> Name of Item</Typography></li>
            <li><input
              id="itemName"
              type="text"
            ...
            <Stack direction="row" spacing={2} >
              <li className='boxLabel'><Typography variant="h6"> Item Quantity</Typography></li>
              <li className='boxLabel'><Typography variant="h6"> Date Purchased</Typography></li>
            </Stack>
            ...
            <li className='boxLabel'><Typography variant="h6"> Description of Item</Typography></li>
            <li><textarea
              id="itemDesc"
              type="text"
            ...
            <li className='boxLabel'><Typography variant="h6"> Tags</Typography></li>
            <div className='tags'>
